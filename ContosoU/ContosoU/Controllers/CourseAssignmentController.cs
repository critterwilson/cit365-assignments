...
namespace ContosoU.Controllers
{
    ...
    {
        private readonly ContosoUContext _context;

        public CourseAssignmentController(ContosoUContext context)
        {
            _context = context;
        }
        ...
        {
            var contosoUContext = _context.CourseAssignments.Include(c => c.Course).Include(c => c.Instructor);
            return View(await contosoUContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("InstructorID,CourseID")] CourseAssignment courseAssignment)
        {
            ...
            ViewData["InstructorID"] = new SelectList(_context.Instructors, "InstructorID", "FirstMidName", courseAssignment.InstructorID);
            return View(courseAssignment);
        }
