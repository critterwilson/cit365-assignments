...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        //// POST: Movies/Index/<searchString>
        //[HttpPost]
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var queryURL = $"http://omdbapi.com/?apikey=c57ffd3f&t={queryTitle}";
            ...
            using (Stream dataStream = res.GetResponseStream())
            {
                ...
                // Display the content.  
                ViewData["PosterURL"] = JsonConvert.DeserializeObject<dynamic>(responseFromServer).Poster;
            }
